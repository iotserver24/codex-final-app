...
export function convertPollinationsModelToModelOption(
  ...
  return {
    ...
    maxOutputTokens: model.maxInputChars
      ? Math.floor(model.maxInputChars * 0.8)
      : undefined,
    contextWindow: model.maxInputChars || 32000,
    tag: model.reasoning ? "Reasoning" : undefined,
    temperature: 1,
    dollarSigns: 1, // All Pollinations models are free
  };
}
...
export const MODEL_OPTIONS: Record<string, ModelOption[]> = {
  ...
  // codex models are now fetched dynamically from Pollinations API
  azure: [
    {
      name: "gpt-5-codex",
      displayName: "GPT-5 Codex",
